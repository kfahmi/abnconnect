...
@section('breadcrumbs')
{{Breadcrumbs::render('permission.update',$data)}}
@endsection
...
@section('content')
<!-- .row -->
{!! Form::open(array('route' => ['permission.update',$data->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
            ...
            <div class="col-sm-12 col-xs-12">
                    ...
                    <div class="form-group {{ $errors->has('name') ? ' has-error ' : '' }}">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="name" class="form-control" id="name" placeholder="Enter Permission Name" value="{{ $data->name }}">
                        </div>
