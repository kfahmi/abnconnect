...
@section('content')
<!-- .row -->
{!! Form::open(array('route' => 'user.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                    ...
                    <div class="form-group {{ $errors->has('realname') ? ' has-error ' : '' }}">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="ti-user"></i></div>
                            <input type="text" class="form-control" name="realname" id="realname" placeholder="Realname" value="{{ old('realname') }}"> 
                        </div>
